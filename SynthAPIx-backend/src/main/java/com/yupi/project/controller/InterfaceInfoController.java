...
public class InterfaceInfoController {
    ...
    public BaseResponse<Boolean> publishInterfaceInfo(@RequestBody IDRequest idRequest,
        ...
        com.zhihao.synthapixclientsdk.model.User user = new com.zhihao.synthapixclientsdk.model.User();
    ...
    public BaseResponse<Object> invokeInterfaceInfo(@RequestBody InterfaceInfoInvokeRequest interfaceInfoInvokeRequest,
        ...
        Gson gson = new Gson();
        com.zhihao.synthapixclientsdk.model.User requestUser = gson.fromJson(userRequestParams,com.zhihao.synthapixclientsdk.model.User.class);
        ApiClient tempClient = new ApiClient(accessKey,secretKey);
        String userName = tempClient.getUsernameByPost(requestUser);
